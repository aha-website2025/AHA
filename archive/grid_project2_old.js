...
async function loadProject() {
  ...
  const tiles = [
    ...
    {
      class: "description",
      style: "grid-column: 4 / 6; grid-row: 1 / 3; span 2;",
    ...
    {
      class: "tile text-left",
      style: "grid-column: 4 / 5; grid-row: 3;",
      html: `
     ...
     {
      class: "tile hatch",
      style: "grid-column: 5 / 6; grid-row: 3",
      html: ""
    },
     {
      class: "tile full-bleed double",
    ...
    {
      class: "tile text-left",
      style: "grid-column: 4 / 5; grid-row: 4;",
      html: `
    ...
    {
      class: "tile hatch",
      style: "grid-column: 5 / 6; grid-row: 7;",
      html: ""
    }
...
function drawVerticalDashedLines() {
  ...
  const tiles = Array.from(container.querySelectorAll(".tile.full-bleed:not(.double), .tile.title"));
