...
async function loadProject() {
  ...
  const tiles = [
    ...
    },
    {
      ...
      style: "grid-column: 2 / 4; grid-row: 1 / 3; span 2;",
      image: "big1",
      alt: "Photo "
    },
    {
    ...
    {
      class: "tile text-left",
      style: "grid-column: 4 / 5; grid-row: 2 / 3;",
      html: `
    ...
    {
      class: "tile hatch",
      style: "grid-column: 5 / 6; grid-row: 2 / 3",
      html: ""
    },
    ...
    {
      class: "description",
      style: "grid-column: 3 / 5; grid-row: 3 / 5; span 2;",
    ...
    },
    {
     ...
     {
      class: "tile full-bleed double",
      style: "grid-column: 4 / 6; grid-row: 5 / 7; span 2;",
      image: "big2",
      alt: "Photo 5"
    },
    ...
    {
      class: "tile full-bleed double",
      style: "grid-column: 2 / 4; grid-row: 6 / 8; span 2;",
      image: "big3",
      alt: "Photo 8"
    },
    {
